...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : BUZZER_Pin MOTOR_AIN1_Pin MOTOR_AIN2_Pin */
  GPIO_InitStruct.Pin = BUZZER_Pin|MOTOR_AIN1_Pin|MOTOR_AIN2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : IR_SPEED_Pin */
  GPIO_InitStruct.Pin = IR_SPEED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(IR_SPEED_GPIO_Port, &GPIO_InitStruct);
